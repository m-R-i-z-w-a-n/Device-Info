    ...
    private fun initViews() {
        ...
        navView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.item_os -> {
                    replaceFragment(OSFragment())
                    
                }
                R.id.item_cpu -> {
                    replaceFragment(CPUFragment())
                    
                }
                R.id.item_battery -> {
                    replaceFragment(BatteryFragment())
                ...
                R.id.item_features -> {
                    replaceFragment(FeaturesFragment())
                    
                }
                R.id.item_user_apps -> {
                    replaceFragment(UserAppsFragment())
                    
                }
                R.id.item_system_apps -> {
                    replaceFragment(SystemAppsFragment())
                }
                R.id.item_test -> {
                    replaceFragment(TestMyDeviceFragment())
                }
                R.id.item_settings -> {
